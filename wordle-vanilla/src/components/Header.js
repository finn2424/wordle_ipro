export class Header {
    constructor(onOpenInstructions, onOpenStats) {
        ...
        this.element.innerHTML = `
            ...
            <div class="header-center" style="display: flex; align-items: center; gap: 0.5rem;">
                <h1 style="margin: 0; font-size: 2.25rem; font-weight: 800; letter-spacing: 2px;">WORDLE</h1>
                <span style="background-color: #f0f0f0; color: #121213; font-size: 0.75rem; font-weight: bold; padding: 2px 6px; border-radius: 4px; letter-spacing: 1px;">VANILLA</span>
            </div>
            <div class="header-right" style="display: flex; gap: 1rem; align-items: center;">
                <div id="btn-instructions" style="cursor: pointer; display: flex; align-items: center; opacity: 0.8; transition: opacity 0.2s;" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.8">
                    <svg style="width: 24px; height: 24px; fill: currentColor;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
